      ...
      <div className="mobile-container">
        ...
        <div className="mobile-section-3">
          <div className="mobile-card-2">
            ...
            <h2>NOSSO CURSO</h2>
            <h1>Decifre a linguagem do corpo</h1>
            <h3>
              Lorem ipsumNeque porro quisquam est qui do lorem ipsum quia dolor
              sit amet, Neque porro elit NeDque porro Lorem ipsum Neque porro
              Neque porro{" "}
            ...
            <div className="card mobile-type"></div>
            <div className="card mobile-type"></div>
            <div className="card mobile-type"></div>
            <div className="card mobile-type"></div>
          </div>
        ...
        <div className="mobile-section-5">
          <h1>
            APROVEITE NOSSOS CONTEÚDOS<br></br>
        ...
        <div className="mobile-section-6">
          <div className="mobile-card-2">
            <UilBrain color="#630092" size="60"></UilBrain>
            <h2>POR QUE?</h2>
            <h1>Professor com domínio do tema</h1>
            ...
            <ul>
              <li>
                <UilCheckCircle color="#630092"></UilCheckCircle>Clientes
                satisfeitos
              </li>
              <li>
                <UilCheckCircle color="#630092"></UilCheckCircle>Professor
                qualificado
              </li>
              <li>
                <UilCheckCircle color="#630092"></UilCheckCircle>Ensino
                modernizado
              </li>
            </ul>
          </div>
        ...
        <div className="mobile-section-7">
          <div className="head-skull-bg"></div>
          <div className="content-section-7"></div>
        </div>
      </div>
    );
  }
